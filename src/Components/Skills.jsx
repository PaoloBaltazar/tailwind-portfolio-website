      ...
      <section className="text-white content-center">
        ...
        <div className="grid gap-8 justify-items-center md:grid-cols-2 lg:grid-cols-3">
          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>JavaScript</h1>
            <img className='w-16' src={javascript}/>
          </div>

          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>React.js</h1>
            <img className='w-16' src={react}/>
          </div>

          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>Python</h1>
            <img className='w-16' src={python}/>
          </div>

          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>HTML</h1>
            <img className='w-16' src={html}/>
          </div>

          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>CSS</h1>
            <img className='w-16' src={css}/>
          </div>

          <div className="w-80 h-56 text-center border content-center justify-items-center">
            <h1 className='font-primaryMedium text-3xl mb-4'>Tailwind</h1>
